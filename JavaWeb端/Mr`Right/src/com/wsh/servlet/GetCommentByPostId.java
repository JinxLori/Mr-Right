...
/**
 * Servlet implementation class getCommentByPostId
 */
@WebServlet("/GetCommentByPostId")
public class GetCommentByPostId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		comments = commentService.getCommentByPostId(Integer.parseInt(post_id),Integer.parseInt(user_id));
