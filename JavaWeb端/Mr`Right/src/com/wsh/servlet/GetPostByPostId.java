...
/**
 * Servlet implementation class GetPostByPostId
 */
@WebServlet("/GetPostByPostId")
public class GetPostByPostId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		posts = postService.getPostByPostId(Integer.parseInt(post_id),Integer.parseInt(user_id));
